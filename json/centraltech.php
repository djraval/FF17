...
$myfile = fopen("technical/js/nct.json", "r") or die("Unable to open file!");
  $data = fread($myfile,filesize("technical/js/nct.json"));
    ...
    function convertq($string)
{
  ...
  if(isset($_POST['new']) || isset($_POST['edit'])) {
    ...
    if(isset($_POST['edit'])) {
	$data["ct"][$branch][$_POST['event']] = $event;
    }
    else {
    ...
    $myfile = fopen("technical/js/nct.json", "w") or die("<br><br><br>Unable to 
open file!");
