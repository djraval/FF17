...
$myfile = fopen("technical/js/ncultural.json", "r") or die("Unable to open file!");
  $data = fread($myfile,filesize("technical/js/ncultural.json"));
...
<div class="container-fluid" style="width: 65%;">
  <div class="row">
	...
	<li class="active col-md-6"><a data-toggle="tab" href="#home">New event</
//   var_dump($data);a></li>
	...
	<div id="home" class="tab-pane fade in active">
	  ...
	  <form action="" method="post">
		...
		<div class="col-md-6">
		  <div class="form-group">
		    <label for="time">Time:</label>
		    <input type="text" class="form-control" id="time" placeholder="Timing" name="time">
		  </div>
		</div>
	      </div>
    ...
    function convertq($string)
{
  ...
  if(isset($_POST['new']) || isset($_POST['edit'])) {
	...
	$data["technical"][$branch][$_POST['event']] = $event;
      ...
      $data["ct"][$branch] = $event;
      $data["ct"][$branch]["totalevents"] = intval($event_no)+1;
    }
    
    var_dump(json_encode($data));
   
    $myfile = fopen("technical/js/ncultural.json", "w") or die("<br><br><br>Unable to open file!");
