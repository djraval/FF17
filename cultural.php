...
$myfile = fopen("cultural/js/ncutural.json", "r") or die("Unable to open file!");
  $data = fread($myfile,filesize("cultural/js/ncultural.json"));
...
//     $event["teamsize"] = $_POST["teamsize"];
    ...
    $myfile = fopen("cultural/js/ncultural.json", "w") or die("<br><br><br>Unable to open file!");
